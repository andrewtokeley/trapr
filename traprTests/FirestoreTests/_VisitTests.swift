    ...
    func testTrapStatistics() {
        ...
        self.createTestData {
            ...
            self.trapStatisticsService.getTrapStatistics(routeId: self.routeLWE_Id, stationId: self.stationLW01_Id, trapTypeId: TrapTypeCode.possumMaster.rawValue) { (statistics, error) in
                ...
                XCTAssert(statistics?.trapSetStatusCounts[TrapSetStatus.stillSet.rawValue] == 1)
                XCTAssert(statistics?.trapSetStatusCounts[TrapSetStatus.setBaitEaten.rawValue] == 2)
